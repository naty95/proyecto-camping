...
<div class="container-fluid mt-5 " style="background-image: url('assets/img/maderitaa.jpg'); width: 100%; height:100%; background-position:fixed" id="carrito">

        <div class = "heading">
            <h2 id="h2" align="center">Reservas</h2>
        </div>
...
if (empty($cart_check)) {
    echo 'Para Reservar, click en "Reservar"';
}
?>
        </div>

        <table class="table"  border="0" cellpadding="10px" cellspacing="5px">

            <?php // Todos los items de carrito en "$cart".
if ($cart = $this->cart->contents()):
?>
                <tr id= "h5 main_heading">
                    <td>ID</td>
                    <td>Descripcion</td>
                    <td>Precio</td>
